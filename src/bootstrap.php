...
register_activation_hook(MUTQAN_FILE,function(){
    ...
    MUTQAN_Accounting::install();
    MUTQAN_Expenses::install();
    MUTQAN_Settlements::install();
    MUTQAN_Warranty::install();
    MUTQAN_Ratings::install();
    MUTQAN_Pricing::install();
    MUTQAN_CRM::install();
    MUTQAN_Quality::install();
    MUTQAN_Marketing::install();
    MUTQAN_Promotions::install();
    MUTQAN_Audit::install();
    MUTQAN_Notifications::install();
});
