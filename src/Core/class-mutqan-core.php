...
final class MUTQAN_Core {
    ...
    public static function register_caps() {
        $caps = array(
            ...
            'mutqan_manage_ai','mutqan_manage_marketing','mutqan_manage_finance','mutqan_manage_accounting','mutqan_manage_expenses','mutqan_manage_settlements','mutqan_manage_wallets','mutqan_manage_commissions','mutqan_manage_technicians','mutqan_manage_dispatch','mutqan_view_analytics'
        );
